    ...
    public class Exercise6
    {
        public void ExecuteExercise()
        {
            ...
            for (var i = 0; i < firstSerialElements.Count; i++)
            {
                ...
                {
                    Console.WriteLine($"El número {firstSerialItem} de la posición {i + 1} de la primera lista es mayor que " +
                                      $"{secondSerialItem} de la misma posición");
                }
                else
                {
                    Console.WriteLine($"El número {firstSerialItem} de la posición {i + 1} de la primera lista es menor que " +
                                      $"{secondSerialItem} de la misma posición");
                }
            }
        }
